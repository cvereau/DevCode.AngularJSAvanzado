...
(function () {
    ...
    angular
        .module('app.widgets')
        .directive('rtBusTracker', rtBusTrackerControl);

    rtBusTrackerControl.$inject = ['fireBaseConfig'];

    function rtBusTrackerControl(fireBaseConfig){
        return{
            templateUrl: 'app/widgets/widgetBusTracker/rtBusTrackerTemplate.html',
            link: function(scope,el,attrs){
                ...
                var geoFire = fireBaseConfig.getGeoFireInstance();
                console.log(geoFire);
                /*************/
                /*  GEOQUERY */
                /*************/
...
// Create a new GeoQuery instance
                ...
                geoQuery.on("key_entered", function(vehicleId, vehicleLocation) {
                    ...
                    fireBaseConfig.transitFirebaseRef.child("sf-muni/vehicles").child(vehicleId).once("value", function(dataSnapshot) {
